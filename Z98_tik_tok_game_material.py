...
def tik_tak_too_game():
    ...
    while c1:
        ...
        if input1 in z1:
            print("")
            print("Player 1 is " + (input1) + " and will move first.")
            print("Player 2 is " + p2 + " and will move after player 1.")
            pk = input1
        else:
            print("")

            print("Player 1 is " + p2 + " and will move first.")
            print("Player 2 is " + (input1) + " and will move after player 1.")
            pk = p2
            ...
            def play(a="   ", b='   ', c='   ', d='   ', e='   ', f='   ', g='   ', h='   ', i='   '):
                ...
                for s in range(100):
                    if (a == b == c == " 0 ") or (a == d == g == " 0 ") or (g == h == i == " 0 ") or (
                            ...
                            a == e == i == " 0 ") or (c == e == g == " 0 "):
                        if input1 in z1:
                            print("Player 1 is " + (input1))
                            print("Player 2 is " + p2)

                        else:
                            print("Player 1 is " + p2)
                            print("Player 2 is " + (input1))
                        print("")
                        print(f"     |     |     ")
                        print(f" {a} | {b} | {c} ")
                        print(f"     |     |     ")
                        ...
                        print("")
                        break
                    elif a in [" x ", " X ", 0, " 0 "] and b in [" x ", " X ", 0, " 0 "] and c in [" x ", " X ", 0,
                                                                                                   " 0 "] and d in [
                        " x ", " X ", 0, " 0 "] and e in [" x ", " X ", 0, " 0 "] and f in [" x ", " X ", 0,
                                                                                            " 0 "] and g in [" x ",
                                                                                                             " X ", 0,
                                                                                                             " 0 "] and h in [
                        " x ", " X ", 0, " 0 "] and i in [" x ", " X ", 0, " 0 "]:
                        z1 = choice([["x", "x"], [0, "0"]])
                        if input1 in z1:
                            print("Player 1 is " + (input1))
                            print("Player 2 is " + p2)
